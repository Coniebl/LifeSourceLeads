...
export function LoginForm() {
  ...
  return (
    <div className="w-full md:w-[45%] lg:w-[40%] h-full flex items-center justify-center bg-[#f5eedb] dark:bg-[#0d0b09] p-6 transition-colors duration-300">
      <div className="w-full max-w-[400px] bg-white dark:bg-[#181512] rounded-3xl shadow-[0_10px_35px_rgba(0,0,0,0.03)] border border-gray-100 dark:border-white/5 p-7 flex flex-col items-center transition-colors duration-300">
